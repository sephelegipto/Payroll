...
Public Class RealStateLoan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Payroll.RealStateLoan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRealStateLoan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RealStateLoan = New RealStateLoan()
        rpt.Site = Me.Site
        Return rpt
    End Function
