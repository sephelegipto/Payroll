...
Public Class GeneralPayrollPage2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "GeneralPayrollPage2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Payroll.GeneralPayrollPage2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CEO() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedGeneralPayrollPage2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GeneralPayrollPage2 = New GeneralPayrollPage2()
        rpt.Site = Me.Site
        Return rpt
    End Function
