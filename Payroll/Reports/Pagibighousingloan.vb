...
Public Class Pagibighousingloan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Payroll.Pagibighousingloan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPagibighousingloan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Pagibighousingloan = New Pagibighousingloan()
        rpt.Site = Me.Site
        Return rpt
    End Function
