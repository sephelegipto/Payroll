...
Public Class ChinabankLoan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Payroll.ChinabankLoan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChinabankLoan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChinabankLoan = New ChinabankLoan()
        rpt.Site = Me.Site
        Return rpt
    End Function
